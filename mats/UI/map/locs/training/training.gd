...
func train_dialog(trained:bool,message_to_train_accepted:bool):
	...
	print(trained," ",message_to_train_accepted)
...
func _on_pl_2_runned_changed(res):
	gm.make_dialog(preload("res://mats/UI/dialog/data/dialogs/story/story_dialog7.tres"))

func _on_pl_3_runned_changed(res: bool) -> void:
	pass # Replace with function body.

func _on_pl_4_runned_changed(res):
	if res and !gm.game_prefs.scripts.lvl5_runned:
		gm.make_dialog(preload("res://mats/UI/dialog/data/dialogs/story/story_dialog8.tres"))
